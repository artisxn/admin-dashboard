...
namespace codicastudio\NovaDashboard\Http\Controllers;

use codicastudio\NovaDashboard\Action;
use codicastudio\NovaDashboard\Card;
use codicastudio\NovaDashboard\WidgetOptionTab;
use codicastudio\NovaDashboard\Dashboard;
use codicastudio\NovaDashboard\Filters;
use codicastudio\NovaDashboard\Models\Widget as WidgetModel;
use codicastudio\NovaDashboard\NovaDashboard;
use codicastudio\NovaDashboard\ValueResult;
use codicastudio\NovaDashboard\View;
use codicastudio\NovaDashboard\Widget;
...
class WidgetController
{
    ...
    private function storeWidget(NovaRequest $request, string $dashboardKey, string $viewKey, string $widgetKey, Collection $fields): WidgetModel
    {
         ...
         * @var WidgetModel $widgetInstance
         */
        $modelClass = config('admin-dashboard.widget_model');
    ...
    {
        return resolve(config('admin-dashboard.widget_model'));
    }
